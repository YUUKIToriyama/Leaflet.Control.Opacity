...
export class Opacity extends leaflet.Control {
	...
	constructor(overlays: leaflet.Layer[], options?: OpacityConstructorOptions) {
		// オプションの管理
		super(options);
...
export namespace L.control {
	export const opacity = (overlays: leaflet.Layer[], options: OpacityConstructorOptions) => {
		return new Opacity(overlays, options)
	}
}